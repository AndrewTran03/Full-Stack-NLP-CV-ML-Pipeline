...
def main(rabbitmq_url: str, prefix: str = "python") -> None:
    ...
    def on_queue_request_received(channel: pika.adapters.blocking_connection.BlockingChannel, method: pika.spec.Basic.Deliver, properties: pika.BasicProperties, body: bytes) -> None:
        global num_request
    ...
    channel.basic_consume(queue=REQUEST_QUEUE, on_message_callback=on_queue_request_received)
